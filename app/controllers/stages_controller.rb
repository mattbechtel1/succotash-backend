class StagesController < ApplicationController
    def create
        ...
        if !params[:due_date]
            ...
            needs_end_date_adjustment = bed.stages.detect {|stage| (stage.start_date < new_start_date && !stage.due_date) || (stage.start_date < new_start_date && stage.due_date >= new_due_date) }
